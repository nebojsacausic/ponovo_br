								...
								<ul class="nav nav-tabs" id="myTab" role="tablist">
											...
											<?php
												...
												foreach($resFetch as $red){
													if($red->id_category == 1){
														$ispis.='<li class="nav-item"><a id="first_cat" class="nav-link active" data-toggle="tab" href="#" role="tab" data-id="'.$red->id_category.'">'.$red->category.'</a></li>';
													}
													else{
														$ispis.='<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#" role="tab" data-id="'.$red->id_category.'">'.$red->category.'</a></li>';
													}
												}
												echo $ispis;
											?>
                ...
                <div class="col-12">
                    <div class="owl-carousel popular-slider">
						...
						<?php
							$query = "SELECT * 
									FROM products INNER JOIN pictures ON products.id_product = pictures.id_product
									ORDER BY products.date_public DESC
									LIMIT 8";
							$ressult = $connection->query($query);
							$resFetch = $ressult->fetchAll();
